...
function set_country (oRegionSel, oCountrySel, oCity_StateSel, oAddressInp) {
  var countryArr;
  oCountrySel.length = 0;
  oCity_StateSel.length = 0;
  oAddressInp.length = 0;
  oAddressInp.placeholder = "";
  var region = oRegionSel.options[oRegionSel.selectedIndex].text;
  if (countries[region]) {
    oCountrySel.disabled = false;
    oCity_StateSel.disabled = true;
    oAddressInp.disabled = true;
...
function set_city_state (oCountrySel, oCity_StateSel, oAddressInp) {
  var city_stateArr;
  oCity_StateSel.length = 0;
  oAddressInp.length = 0;
  oAddressInp.placeholder = "";
  ...
  if (city_states[country]) {
    ...
    for (var i = 0; i < city_stateArr.length; i++) {
      oCity_StateSel.options[i + 1] = new Option(city_stateArr[i]);
    }
  } else {
    oCity_StateSel.disabled = true;
  }
...
function set_address (oCity_StateSel, oAddressInp) {
  var city_state = oCity_StateSel.options[oCity_StateSel.selectedIndex].text;
  if (city_state !== 'Select City/State') {
    oAddressInp.disabled = false;
    oAddressInp.placeholder = "Enter a more precise campground address, eg: 1234 Main St";
  } else {
    oAddressInp.length = 0;
    oAddressInp.placeholder = "";
    oAddressInp.disabled = true;
